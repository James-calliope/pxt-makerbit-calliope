...
namespace makerbit {
    ...
    export function getUltrasonicDistance(unit: DistanceUnit): number {
        ...
        return ultrasonicDevice.medianRoundTrip / unit; // Math.idiv(ultrasonicDevice.medianRoundTrip, unit);
    }
    ...
    export function isUltrasonicDistanceLessThan(
        ...
        return ultrasonicDevice.medianRoundTrip / unit < distance; //changed math.idiv
    }
